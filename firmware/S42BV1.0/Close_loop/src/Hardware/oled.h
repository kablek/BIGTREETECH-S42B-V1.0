...
/*************************************** OLED SETINGS ******************************************/
#define OLED_COMMAND_BUFFER_SIZE                64        //Size of circular buffer for storing OLED commands (max size = 256), to small buffer can end up waiting in blocking mode
...
//TODO: Do something a bit smarter about those above maybe in the future? multi byte implementation friendly maybe
